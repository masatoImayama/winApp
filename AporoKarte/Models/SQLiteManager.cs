...
namespace System.Data.SQLiteManager
{
    ...
    class SQLiteAdapter : IDisposable
    {
        ...
        /// <returns>自動で割り振られた番号</returns>
        /// <exception cref="SQLiteException">SQLの実行時エラーが発生した時</exception>
        public int GetIncrementId(string tableName)
        {
            try
            {
                //AUTOINCREMENTされた値を取得
        ...
        public String ChainSeparateStr(int chainCount, String chainStr, String sepStr)
        {
            ...
            {
                chainList.Add(chainStr);
            }
            return String.Join(sepStr, chainList.ToArray());
        }

        public String ChkEmptyVal(String value)
        {
...
//    class DAO
//    {
//        static SQLiteConnection _dbCon = null;
//        static void Main()
//        {
...
//            conStr.Append(Properties.Settings.Default.DBPath);
//            conStr.Append(";Version=3;");

//            try
//            {
//                _dbCon = new SQLiteConnection();
//                _dbCon.ConnectionString = conStr.ToString();
//                _dbCon.Open();
//            } catch (Exception e)
//            {
//                throw e;
...
//        /// 取得SQLの発行
//        /// </summary>
//        public static IList<IDictionary<String,Object>> SelectDataset(String SqlStr, IDictionary<String, Object> Parameters)
//        {
//            IList<IDictionary<String, Object>> Dt = new List<IDictionary<String, Object>>();

//            SQLiteCommand command = _dbCon.CreateCommand();
